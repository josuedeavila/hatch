...
func Run(ctx context.Context, version string, targets *target.Set, args []string, stdout, stderr io.Writer) error {
	if len(args) < 2 {
...
// commonFlags adds the flags shared by build/list/clean.
